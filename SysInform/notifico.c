    ...
    )
{
    ...
    PhNfRegisterIcon(NULL, PH_TRAY_ICON_ID_PLAIN_ICON, PhNfpTrayIconItemGuids[PH_TRAY_ICON_GUID_PLAIN_ICON], NULL, L"SysInform icon (static)", 0, PhNfpPlainIconUpdateCallback, NULL);
    ...
    )
{
    ...
    if (!string)
    {
        PH_STRINGREF text = PH_STRINGREF_INIT(L"SysInform");
