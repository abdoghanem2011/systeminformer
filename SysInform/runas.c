 ...
 *
 * \remarks This function will cause another instance of SysInform to be executed if the current security context
    ...
    )
{
    ...
    memcpy(serviceName, L"SysInform", 14 * sizeof(WCHAR));
