    ...
    case WM_INITDIALOG:
        {
            ...
            PhSetDialogItemText(hwndDlg, IDC_CREDITS,
                ...
                L"    <a href=\"https://github.com/winsiderss/SysInform/graphs/contributors\">Contributors</a> - thank you for your additions!\n"
                L"    Donors - thank you for your support!\n\n"
                L"SysInform uses the following components:\n"
    ...
    )
{
    ...
    if (LinkToCommit)
    {
        ...
        // "SysInform %lu.%lu.%lu (<a href=\"https://github.com/winsiderss/SysInform/commit/%hs\">%hs</a>) %ls"
        PhInitFormatS(&format[0], L"SysInform ");
        PhInitFormatSR(&format[1], commitversionString->sr);
        PhInitFormatS(&format[2], L" (<a href=\"https://github.com/winsiderss/SysInform/commit/");
