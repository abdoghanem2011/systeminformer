    ...
    )
{
    ...
    menu = PhCreateEMenu();
    PhInsertEMenuItem(menu, PhCreateEMenuItem(0, ID_ICON_SHOWHIDEPROCESSHACKER, L"&Show/Hide SysInform", NULL, NULL), ULONG_MAX);
    ...
    case PH_NOTIFY_PROCESS_CREATE:
        {
            ...
            {
                SysInform_SelectTabPage(PhMwpProcessesPage->Index);
                SysInform_SelectProcessNode(processNode);
                SysInform_ToggleVisible(TRUE);
            }
            else
            {
                PhShowStatus(PhMainWndHandle, L"The process does not exist.", STATUS_INVALID_CID, 0);
    ...
    case PH_NOTIFY_SERVICE_STOP:
        {
            ...
            {
                SysInform_SelectTabPage(PhMwpServicesPage->Index);
                SysInform_SelectServiceItem(serviceItem);
                SysInform_ToggleVisible(TRUE);
