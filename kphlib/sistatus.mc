...
FacilityNames = (
    System          = 0x0
    SysInform  = 0x1:FACILITY_SI
    DynamicData     = 0x2:FACILITY_SI_DYNDATA
    KSysInform = 0x3:FACILITY_KSI
    )
...
Language     = English
SysInform dynamic data is not yet supported on this kernel version.
.
...
Language     = English
SysInform dynamic data version is incompatible.
.
...
Language     = English
SysInform dynamic data is an invalid length.
.
...
Language     = English
SysInform dynamic data signature is invalid.
.
...
Language     = English
SysInform kernel library version is incompatible.
.
